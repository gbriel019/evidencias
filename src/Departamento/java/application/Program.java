...
import _entities.Departament;
import _entities.HourContract;
import _entities.Worker;
...
public class Program {
    public static void main (String []args)  throws ParseException {
        ...
        System.out.println();
        System.out.print("Entre com mes e ano para calcular os ganhos (MM/YYYY): ");
        ...
        System.out.println("Ganhos por: " + monthAndYear + ": " + String.format("%.2f", worker.income(year , month)));
